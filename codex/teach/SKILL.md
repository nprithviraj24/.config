---
name: teach
description: Teach the user a new skill or concept in a stateful local learning workspace. Use when the user asks to learn, be taught, start or resume lessons, build reference material, or explicitly invokes $teach or /teach-style learning.
---
